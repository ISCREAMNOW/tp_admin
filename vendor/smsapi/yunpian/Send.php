...
$GLOBALS['sms_options'] = [
    'apikey' => sysconf('mobile_key'),
    'signature' => sysconf('mobile_signature')
];
...
function send_sms($content, $mobile){
	...
	return Send::sendSms($path, $GLOBALS['sms_options']['apikey'], str_replace(sysconf('web_title'), $GLOBALS['sms_options']['signature'], $content), $mobile);
}
