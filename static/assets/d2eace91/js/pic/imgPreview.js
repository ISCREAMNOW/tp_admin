	...
	$.fn.imagePreview = function() {
		$(this).hover(function() {
			...
			if (ref != '') {
				...
				$(this).attr("ref", "../../../../images/default/goods.gif"/*tpa=http://seller.qm48td.yunmall.68mall.com/images/default/goods.gif*/);
				$(this).append("<p id='imgpreview'><img src='../../../../images/default/goods.gif'/*tpa=http://seller.qm48td.yunmall.68mall.com/images/default/goods.gif*//>" + b + "</p>");
				$("#imgpreview").css("left", (w + 10) + "px").fadeIn("fast");
			}
